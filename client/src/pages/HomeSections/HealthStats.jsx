...
const HealthStats = () => {
  ...
  const statsMeta = [
    {
      ...
      icon: HeartHandshake,
      color: 'text-darkPrimary border-darkPrimary/20 bg-darkPrimary/5',
      suffix: '+'
    },
    {
      key: 'activePatients',
    ...
    },
    {
      ...
      icon: Brain,
      color: 'text-darkSecondary border-darkSecondary/20 bg-darkSecondary/5',
      suffix: '+'
    },
    {
      key: 'recoveryRate',
  ...
  return (
    <section className="py-20 px-6 max-w-7xl mx-auto relative" id="statistics">
      ...
      <div className="absolute top-1/2 left-1/4 -translate-x-1/2 w-80 h-80 rounded-full bg-darkPrimary/5 blur-[120px] pointer-events-none"></div>

      <div className="glass-panel rounded-3xl p-8 md:p-12 relative overflow-hidden">
        {/* Border outline gradient glow */}
        <div className="absolute -inset-px bg-gradient-to-r from-darkPrimary/20 to-darkSecondary/20 rounded-3xl pointer-events-none"></div>
        ...
        <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-8 mb-12 relative z-10">
          <div>
            ...
            <h2 className="font-sora text-3xl md:text-4xl font-bold text-white leading-tight">
              Live Clinical <span className="bg-gradient-to-r from-darkPrimary to-darkSecondary bg-clip-text text-transparent">Statistics</span>
            </h2>
          ...
          <button 
            onClick={fetchStats}
            disabled={loading}
            className="flex items-center gap-2 px-5 py-2.5 rounded-xl bg-white/5 border border-white/10 hover:border-darkPrimary/30 hover:bg-darkPrimary/10 text-xs font-bold text-gray-300 hover:text-white transition-all disabled:opacity-50 shrink-0"
          >
          ...
          {statsMeta.map((item, idx) => {
            ...
            return (
              <ScrollReveal key={idx} direction="up" delay={idx * 0.08}>
                <div className="glass-panel border-white/5 p-6 rounded-2xl flex flex-col justify-between hover:border-white/15 transition-all">
